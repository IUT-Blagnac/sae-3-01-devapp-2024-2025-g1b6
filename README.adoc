...
- Version courante : https://github.com/IUT-Blagnac/sae-3-01-devapp-2024-2025-g1b6/releases/tag/Release.2.0[V2.0]
...
=== Fiche conseil 
link:documentation/Fiche_conseil.pdf[Lien vers la fiche conseil]
...
=== retour semaine 50
Je n'ai toujours pas de milestone sur les US ou les issues, les issues ne sont pas ratachées aux US, j'ai toujours autant de mal à savoir où vous en êtes (l'onglet current iteration est vide !). La recette de tests n'a pas évoluée depuis 2 semaines ... pas d'évolution des autres docs.
