...
('Pack miniatures', 'Miniatures de véhicules divers'),
('Pack poupées', 'Poupées et accessoires'),
('Pack aventure', 'Jeux pour petits explorateurs'),
('Pack cuisine', 'Jouets pour futurs chefs');
...
(22, 'The Legend of Zelda Breath of the Wild 2', 'Jeu vidéo The Legend of Zelda Breath of the Wild 2', 69.99, 'Multicolore', 'DVD', 0.1, 100, 1),
...
INSERT INTO PRODUIT (IDMARQUE, NOMPROD, DESCPROD, PRIXHT, COULEUR, COMPOSITION, POIDSPRODUIT, QTESTOCK, DISPONIBLE) VALUES
(151, 7, 'Voiture de sport', 'Voiture de sport rapide', 29.99, 'Rouge', 'Plastique', 0.5, 50, 1),
(152, 7, 'Voiture de police', 'Voiture de police avec sirène', 24.99, 'Bleu', 'Plastique', 0.6, 40, 1),
(153, 7, 'Voiture F1', 'Voiture de course télécommandée', 34.99, 'Jaune', 'Plastique', 0.7, 30, 1),
(154, 7, 'Camion de Police', 'Camion de pompier avec échelle', 39.99, 'Rouge', 'Plastique', 1.0, 25, 1),
(155, 7, 'Camion Tortue Ninja', 'Camion benne pour chantier', 29.99, 'Jaune', 'Plastique', 1.2, 20, 1),
(156, 7, 'Camion de livraison', 'Camion de livraison avec portes ouvrantes', 34.99, 'Blanc', 'Plastique', 1.1, 30, 1),
(157, 7, 'Avion de chasse', 'Avion de chasse rapide', 49.99, 'Gris', 'Plastique', 0.8, 20, 1),
(158, 7, 'Avion de ligne', 'Avion de ligne avec passagers', 59.99, 'Blanc', 'Plastique', 1.5, 15, 1),
(159, 7, 'Hélicoptère de secours', 'Hélicoptère de secours avec treuil', 44.99, 'Rouge', 'Plastique', 1.0, 25, 1);
