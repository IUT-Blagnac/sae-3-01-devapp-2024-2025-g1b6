            ...
            <div class="inscription">
                ...
                <div class="infos">
                    <form class="formInscription" action="compte.php" method="post">
                        ...
                        <input class="nom" type="text" id="prenom" name="prenom" required>
                        <label for="telephone">Téléphone</label>
                        <input class="tel" type="text" id="telephone" name="telephone" required>
                        <br>
                        <label for="email">Email</label>
                        <input class="mail" type="email" id="email" name="email" required>
                        <br>
                        <label for="dtn">Date de naissance</label>
                        <input class="dtn" type="date" id="dtn" name="dtn" required>
                        <br>
