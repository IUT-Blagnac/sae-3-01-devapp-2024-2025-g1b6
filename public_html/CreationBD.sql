...
CREATE TABLE IF NOT EXISTS COMMANDE
 (
   ...
   IDLIVRAISON INTEGER(7) NOT NULL  ,
...
CREATE TABLE IF NOT EXISTS LIVRAISON
 (
   ...
   IDADRESSE INTEGER(7) NOT NULL  ,
   NUMCOMMANDE INTEGER(9) NOT NULL  ,
   STATUTLIVRAISON VARCHAR(30) NOT NULL  ,
...
CREATE  INDEX I_FK_LIVRAISON_TRANSPORTEUR
     ON LIVRAISON (IDTRANSPORTEUR ASC);

CREATE  INDEX I_FK_LIVRAISON_ADRESSE
     ON LIVRAISON (IDADRESSE ASC);

CREATE UNIQUE INDEX I_FK_LIVRAISON_COMMANDE
     ON LIVRAISON (NUMCOMMANDE ASC);
...
ALTER TABLE LIVRAISON 
  ADD FOREIGN KEY FK_LIVRAISON_TRANSPORTEUR (IDTRANSPORTEUR)
      REFERENCES TRANSPORTEUR (IDTRANSPORTEUR) ;


ALTER TABLE LIVRAISON 
  ADD FOREIGN KEY FK_LIVRAISON_ADRESSE (IDADRESSE)
      REFERENCES ADRESSE (IDADRESSE) ;


ALTER TABLE LIVRAISON 
  ADD FOREIGN KEY FK_LIVRAISON_COMMANDE (NUMCOMMANDE)
