...
DROP TABLE IF EXISTS ASSOPACK;
DROP TABLE IF EXISTS APPARTENIRCATEG;
DROP TABLE IF EXISTS POSSEDERIP;
DROP TABLE IF EXISTS POSSEDERADR;
DROP TABLE IF EXISTS COMMANDE;
DROP TABLE IF EXISTS CATPERE;  -- Suppression de CATPERE avant CATEGORIE
DROP TABLE IF EXISTS PRODUIT;
DROP TABLE IF EXISTS CLIENT;
DROP TABLE IF EXISTS INFORMATIONPAIEMENT;
DROP TABLE IF EXISTS ADRESSE;
DROP TABLE IF EXISTS PACK;
DROP TABLE IF EXISTS CATEGORIE;  -- Maintenant possible après CATPERE
...
CREATE TABLE IF NOT EXISTS TRANSPORTEUR
 (
   IDTRANSPORTEUR INTEGER(5) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS PACK
 (
   IDPACK INTEGER(5) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS MARQUE
 (
   IDMARQUE INTEGER(5) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS COMMANDE
 (
   NUMCOMMANDE INTEGER(9) NOT NULL  AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS ADRESSE
 (
   IDADRESSE INTEGER(7) NOT NULL  AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS CLIENT
 (
   IDCLIENT INTEGER(7) NOT NULL  AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS PRODUIT
 (
   IDPROD INTEGER(7) NOT NULL  AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS CATEGORIE
 (
   IDCATEG INTEGER(5) NOT NULL  AUTO_INCREMENT,
...
CREATE IF NOT EXISTS PANIER (
    IDCLIENT INT NOT NULL,
    IDPROD INT NOT NULL,
    IDCOMMANDE INT,
    QUANTITEPROD INT NOT NULL,
    PRIMARY KEY (IDCLIENT, IDPROD),
    FOREIGN KEY (IDCOMMANDE) REFERENCES COMMANDE(NUMCOMMANDE)
);
 comment = "";
...
CREATE TABLE IF NOT EXISTS CATPERE
 (
   IDCATEG_PERE INTEGER(5) NOT NULL  ,
   IDCATEG INTEGER(5) NOT NULL  
   , PRIMARY KEY (IDCATEG_PERE,IDCATEG) 
 ) 
 comment = "";

# -----------------------------------------------------------------------------
#       INDEX DE LA TABLE CATPERE
# -----------------------------------------------------------------------------


CREATE  INDEX I_FK_CATPERE_CATEGORIE
     ON CATPERE (IDCATEG_PERE ASC);

CREATE  INDEX I_FK_CATPERE_CATEGORIE2
     ON CATPERE (IDCATEG ASC);
...
ALTER TABLE CATPERE 
  ADD FOREIGN KEY FK_CATPERE_CATEGORIE (IDCATEG_PERE)
      REFERENCES CATEGORIE (IDCATEG) ;


ALTER TABLE CATPERE 
  ADD FOREIGN KEY FK_CATPERE_CATEGORIE2 (IDCATEG)
      REFERENCES CATEGORIE (IDCATEG) ;
